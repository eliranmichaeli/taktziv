  ...
  return (
    <div className="bg-surface-container-high rounded-2xl p-5 border border-outline-variant/8">
      ...
      <div className="flex gap-2 pt-1">
        <button
          onClick={onDeposit}
          className="flex-1 py-2 bg-primary/10 text-primary rounded-xl text-xs font-bold hover:bg-primary/20 transition-colors"
        >
          {t('he', 'deposit')}
        </button>
        <button onClick={onEdit}   className="p-2 rounded-xl hover:bg-surface-container-highest text-on-surface-variant hover:text-primary transition-colors">
          <Pencil size={14} />
        </button>
        <button onClick={onDelete} className="p-2 rounded-xl hover:bg-error/10 text-on-surface-variant hover:text-error transition-colors">
          <Trash2 size={14} />
        </button>
      </div>
    </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <AnimatePresence>
        {planModal && (
          <PlanModal
            stype={planModal.stype}
            existing={planModal.plan}
            sym={sym}
